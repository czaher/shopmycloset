        ...
        <div className='grid md:grid-cols-2 gap-10 items-start'>
          ...
          <div className='flex flex-col gap-6'>
            <div>
              ...
              {item.description && (
                <p className='mt-4 text-warm-brown/80 leading-relaxed text-sm'>
                  {item.description}
                </p>
              )}
            </div>
            ...
            {success && (
              <div className='border border-terra/30 bg-terra/10 rounded-2xl p-5 text-center'>
                ...
                <p className='text-sm text-muted-brown mt-2'>
                  I&apos;ll reach out to get this to you. ty!
                </p>
                <Link
                  href='/'
                  className='mt-4 inline-block text-sm text-terra underline'
                >
                  more stuff
                </Link>
              </div>
            ...
            {item.status === 'reserved' && !success && (
              <div className='border border-warm-beige rounded-2xl p-5 text-center bg-white'>
                <p className='font-serif text-lg text-muted-brown'>
                  Claimed... too slow.
                </p>
                <Link
                  href='/'
