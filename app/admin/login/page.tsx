  ...
  return (
    <div className='min-h-screen bg-cream flex items-center justify-center px-6'>
      <div className='w-full max-w-sm'>
        <h1 className='font-serif text-3xl text-warm-brown text-center mb-2'>
          admin zone
        </h1>
        <p className='text-center text-sm text-muted-brown mb-8'>
          enter if u dare
        </p>

        <form
          onSubmit={handleLogin}
          className='flex flex-col gap-4 bg-white border border-warm-beige rounded-2xl p-7'
        >
          <div>
